      ...
      text={
        <>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to interaction.study, accessible from{" "}
                <a
                  href="https://interaction.study"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://interaction.study
                </a>
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            our copyright agent via email at hello@mnemoscene.io and include in
          ...
          <p>
            ...
            hello@mnemoscene.io. Upon receipt of a notification, the Company
          ...
          <ul>
            <li>
              ...
              <a
                href="https://interaction.study/docs/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://interaction.study/docs/contact
              </a>
            </li>
          </ul>
        </>
